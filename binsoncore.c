...
inline int32_t asint(value v) { return *(int32_t *) (v); }
inline double asdouble(value v) { return  *(double *) (v); }
inline bool asboolean(value v) { return *(BYTE *) (v); }
inline char* asstring(value v) { return  (char *) ((v) + 4); }
